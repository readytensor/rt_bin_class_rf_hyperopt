...
def run_batch_predictions(
    ...
    try:
        ...
        logger.info(f"predictor_model.decision_threshold: {predictor_model.decision_threshold}")
        logger.info(f"predictor_model.positive_class_weight: {predictor_model.positive_class_weight}")
